...
class f1_propriedade(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterString('id', 'ID da Área Contratada', multiLine=False, defaultValue='AAA-UF0001-01'))
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('refatorado', 'Polígonos Corrigidos para envio ao HorusBI - Salvar como o exemplo AAA-UF0001 ou AAA-UF0001-01', optional=True, type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        if parameters['id'] == 'AAA-UF0001-01':
            feedback.reportError("""ATENÇÃO! OBSERVE O ERRO ABAIXO:
            ...
            """)
            feedback.pushInfo("""Nenhum código foi inserido para o ID. Insira o código desta área e execute novamente.
        ...
        # Editar campos
        alg_params = {
            'FIELDS_MAPPING': [{'expression': '\"id\"','length': 15,'name': 'id','precision': 0,'type': 10},{'expression': 'to_date(now())','length': 0,'name': 'dt_arquivo','precision': 0,'type': 14}],
            'INPUT': outputs['Dissolver']['OUTPUT'],
    ...
    def displayName(self):
        ...
        """
        return ' Preparar Polígonos (Shapefile)'
  ...
  <body bgcolor=#fcfcfc style="font-family:Tahoma;text-align:justify;">      
    ...
    <h3>Preparar Arquivo para envio ao HorusBI - Palladium</h3>
    <br>    Ferramenta utilizada para corrigir e preparar o arquivo a ser carregado no HorusBI.
        Selecione os arquivos que representem <b>apenas uma propriedade OU área em execução (ID)</b>.
    Os arquivos selecionados podem ser de qualquer tipo de geometria: pontos, linhas ou polígonos, simultaneamente.
        ...
        Insira o ID da área em questão.
    
    <b>O arquivo gerado deverá ser <font color=red>salvo</font> com a nomenclatura <b>AAA-UF0000-00</b> e estará pronto para <font color=red>envio</font> ao HorusBI</b>.
